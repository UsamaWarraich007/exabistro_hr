...
import 'Recuruitment Employee Profile.dart';

class RecruitmentEmployee extends StatefulWidget {
  const RecruitmentEmployee({Key? key}) : super(key: key);

  @override
  _RecruitmentEmployeeState createState() => _RecruitmentEmployeeState();
}

class _RecruitmentEmployeeState extends State<RecruitmentEmployee> {
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (BuildContext context, int index) {
                                      return Card(
                                        ...
                                        child: InkWell(
                                          onTap: (){
                                            Navigator.push(context, MaterialPageRoute(builder: (context)=>RecruitmentEmployeeProfile()));
                                          },
                                          child: ListTile(
