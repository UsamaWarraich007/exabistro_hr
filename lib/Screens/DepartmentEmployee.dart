...
class DepartmentEmployee extends StatefulWidget {
  const DepartmentEmployee({Key? key}) : super(key: key);

  @override
  _DepartmentEmployeeState createState() => _DepartmentEmployeeState();
}

class _DepartmentEmployeeState extends State<DepartmentEmployee> {
